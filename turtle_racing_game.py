...
def display_message(message):
    # Clear previous message and display the new one
...
message_turtle.goto(0, 150)  # Position the message turtle at the top of the screen
...
while is_race_on:
    for turtle in all_turtles:
        ...
        if turtle.xcor() > 230:
            ...
            break  # Exit the loop once the race is over
